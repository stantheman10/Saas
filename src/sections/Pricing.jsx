        ...
        <section>
            <Element name="pricing">
                <div className="container">
                    <div className="max-w-960 pricing-head_before relative mx-auto border-l border-r border-s2
                    bg-s1/50 pb-40 pt-28 max-xl:max-w-4xl max-lg:border-none max-md:pb-32 max-md:pt-16">
                        ...
                        <div className='pricing-bg'>
                            ...
                            <img src="/images/bg-outlines-fill.pngg" width={960} height={380} className='absolute inset-0 opacity-5 mix-blend-soft-light z-3' alt="outline" />
                        </div>
                    </div>
                    <div className='scroll-hide relative z-2 -mt-12 flex items-start max-xl:gap-5 max-xl:overflow-auto max-xl:pt-6'>
                        {plans.map((plan, index) => (
                            <div key={plan.id} className="pricing-plan_first pricing-plan_last
                            pricing-plan_odd pricing-plan_even relative border-2 p-7 max-xl:min-w-80 max-lg:rounded-3xl xl:w-[calc(33.33%+2px)]
                            ">
                                {index == 1 && (
                                    <div className='g4 absolute h-330 left-0 right-0
                                    top-0 z-1 rounded-tl-3xl rounded-tr-3xl'/>
                                )}

                                <div className={clsx("absolute left-0 right-0 flex items-center justify-center", index == 1 ? "-top-6" : "-top-6 xl:-top-11")}>
                                    <img src={plan.logo} alt={plan.title}
                                        className={clsx("object-contain z-2 drop-shadow-2xl", index == 1 ? "size-[120px]" : "size-[88px]")}
                                    />
                                </div>
                                ...
                                {index == 1 && (
                                    <p
                                        className='small-compact mt-9 text-center text-p3 before:content-["-"] after:content-["-"] '
