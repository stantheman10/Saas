                ...
                <div className="container">
                    <div className="flex items-center">
                        ...
                        ">
                            ...
                            <p className='body-1 mb-10 max-w-md'>Try it now for free on iOS, android, PC, Web - Whatevber your flavour we got u  </p>

                            <ul className='flex flex-wrap items-center gap-6'>

                                {links.map(({ id, url, icon }) => (
                                    <li key={id} className="download_tech-link download_tech-link_ladt-before download_tech-link_last-after">
                                        <a href={url} className='size-32 download_tech-icon_before relative flex
                                            items-center justify-center rounded-half border-2 border-s3 bg-s1 transition-borderColor duration-500
                                        '>
                                            <span className='absolute -top-2 rotate-90'>
                                                <Marker />
                                            </span>
                                            <img src="/images/lines.svg" alt="lines" className='absolute size-13/20 object-contain' ></img>
                    ...
                    <ul className='flex  justify-center mt-24 max-lg:hidden gap-10 '>
