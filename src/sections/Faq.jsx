                ...
                <div className="relative container z-2 py-28">
                    <div>
                        ...
                        <p className="body-1 max-lg:max-w-sm">
                            Youve got questions and we have got answers
                        </p>
                    </div>
                    ...
                    <div className='container flex gap-10 max-lg:block'>
                        ...
                        <div className='relative flex-1 pt-24'>
                            {faq.slice(0, halfLength).map((item, index) => (
                                <div>
                                    <FaqItem key={item.id} item={item} index={index} className />
                                </div>
                            ))}
                        ...
                        <div className='relative flex-1 lg:pt-24'>
                            {faq.slice(halfLength).map((item, index) => (
                                <div>
                                    <FaqItem key={item.id} item={item} index={halfLength + index} className />
                                </div>
                            ))}

                        </div>
                    </div>
                    <div className='faq-lin-after absolute left-[calc(50%-1ppx) top-0 -z-1] h-full w-0.5 bg-s2 max-lg:hidden' />
                </div>
            </Element>
        </section>
    )
