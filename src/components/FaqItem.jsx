    ...
    return (
        <div className="relative z-2 mb-16">
            ...
            >
                ...
                <div className={clsx("faq-icon relative flex size-12 items-center justify-center rounded-full border-2 border-s2 shadow-400 transition-all duration-500",
                    "group-hover:border-s4", active && "before:bg-p1 after:rotate-0 after:bg-p1"
                )}>
            ...
            <SlideDown>
                {activeId === item.id && (
                    <div className={clsx("body-3 px-7 py-3.5")}>{item.answer}</div>
                )}
            </SlideDown>
